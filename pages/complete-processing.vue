          ...
          <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="mb-4">
              ...
              <select v-model="subtitleSettings.animationStyle" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500">
                <optgroup label="🔥 Viral Templates">
                  <option value="girlboss">💅 Girlboss - Bold pink/purple animations</option>
                  <option value="hormozi">🚀 Hormozi - Business motivational style</option>
                  <option value="tiktokstyle">📱 TikTok Style - Social media trending</option>
                </optgroup>
                <optgroup label="⚡ Impact Templates">
                  <option value="whiteimpact">⚪ White Impact - Clean white highlights</option>
                  <option value="impactfull">💥 Impact Full - Maximum visual impact</option>
                  <option value="thinToBold">📈 Thin to Bold - Progressive emphasis</option>
                </optgroup>
                <optgroup label="🎨 Creative Templates">
                  <option value="wavyColors">🌊 Wavy Colors - Flowing rainbow effects</option>
                  <option value="revealEnlarge">🔍 Reveal Enlarge - Zoom-in discovery</option>
                  <option value="shrinkingPairs">📐 Shrinking Pairs - Minimalist pairs</option>
                </optgroup>
              </select>
              ...
              <div class="mt-2 p-3 bg-gradient-to-r from-gray-700 to-gray-600 rounded-lg border border-gray-500">
                ...
                <div class="flex items-center justify-between">
                  <div class="text-xs text-gray-400">
                    🎨 <span class="inline-block w-3 h-3 rounded-full ml-1" :style="{ backgroundColor: subtitleSettings.primaryColor }"></span>
                  ...
                  <div class="text-xs text-gray-400">{{ subtitleSettings.fontSize }}px • {{ subtitleSettings.wordMode }} • {{ subtitleSettings.verticalPosition }}</div>
                </div>
              </div>
            </div>
            ...
            <div class="mb-4">
              <label class="block text-sm font-medium mb-2">
                Font Family
                <span class="text-xs text-blue-400 ml-2">✨ Template Suggested</span>
              </label>
            ...
            <div class="mb-4">
              ...
              <div class="mt-2 text-xs text-blue-400">
                🎨 Template colors loaded as starting point - customize as needed!
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <select v-model="subtitleSettings.verticalPosition" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500">
                <option value="top">🔝 Top - Subtitles at the top of video</option>
                <option value="center">🎯 Center - Subtitles in the middle</option>
                <option value="bottom">🔽 Bottom - Subtitles at the bottom (default)</option>
              </select>
              <div class="mt-1 text-xs text-blue-400">
                📍 Template position loaded - choose what works best for your video!
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="mt-2 text-xs text-blue-400">
                🎯 Template optimized settings loaded - customize for your style!
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="mb-4">
              ...
              <select v-model="processingOptions.quality" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500">
                <option value="premium">🏆 Premium - Near-lossless quality (CRF 12, slower preset)</option>
                <option value="high">⭐ High Quality - Professional grade (CRF 15, slow preset)</option>
                <option value="standard">🎯 Standard - Balanced quality (CRF 18, medium preset)</option>
                <option value="fast">⚡ Fast - Quick processing (CRF 23, fast preset)</option>
              </select>
          ...
          <div v-if="results.transcription || results.processedVideo" class="bg-gray-800 rounded-lg p-6">
            ...
            <div v-if="results.transcription" class="mb-6">
              <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs text-gray-400">✏️ Editable - Make changes if needed</span>
              </div>
              ...
              <div class="mb-3">
                ...
                <p class="text-xs text-gray-400 mt-1">
                  💡 You can edit the subtitles above. Format: SRT (Sequence number, timestamps, text)
                </p>
              </div>
...
const getTemplateFeatures = (template) => {
  const features = {
    ...
    'shrinkingPairs': '📐 Paired elements • Minimalist design • Shrinking effects'
  }
...
const applyTemplateSettings = (templateName) => {
  ...
  if (templateConfig) {
    console.log(`🎨 Applying predefined ${templateName} template settings:`, templateConfig)
