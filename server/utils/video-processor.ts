...
export class VideoProcessor {
  ...
  private static buildAdvancedProcessingOptions(options?: VideoProcessingOptions): string[] {
    ...
    if (options?.addHandle) {
      ...
      videoFilters.push(`drawtext=text='${handleText}':fontcolor=white:borderw=2:bordercolor=white:fontsize=h/25:x=(w-tw)*${hx}/100:y=(h-th)*${hy}/100:shadowcolor=black@0.8:shadowx=2:shadowy=2:box=1:boxcolor=black@0.4:boxborderw=${padding}`)
    }
